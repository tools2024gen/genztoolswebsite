    ...
    <footer className="bg-gray-800 text-white py-8 mt-20">
      <div className="container mx-auto flex flex-col items-center lg:flex-row lg:justify-between">
        <div className="text-center mb-6 lg:text-left lg:mb-0">
          ...
          <p className="mt-2">Boost your business with our powerful WhatsApp marketing software.</p>
        </div>
      ...
      <div className="text-center mt-8">
        <p>&copy; {new Date().getFullYear()} WhatsApp Marketing Tool. All rights reserved.</p>
      </div>
    </footer>
  );
}
